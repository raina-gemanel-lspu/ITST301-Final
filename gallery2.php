      ...
      <div class="container position-relative">
        <div class="row d-flex justify-content-center">
          <div class="col-lg-6 text-center">
            ...
            <br>
            <br>
            <p>Using appropriate lighting, backgrounds, and postures, portrait photography, also known as portraiture, aims to capture the essence of an individual or group of individuals.</p>
